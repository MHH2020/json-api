...
For example, profiles could specify rules for particular attributes,
relationships, or links in a resource object. Other profiles could specify rules
for interpreting query parameters that are reserved for implementors, such as
`filter` or `page`.
